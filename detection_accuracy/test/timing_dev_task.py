...
params = {
    ...
    "INTRO_TEXT_TASK" : (f"When you being the experiment, you will be presented with a fixation cross."
...
fix_cross  = stimuli.FixCross(size       = params["FIXATION_CROSS_SIZE"],
						  position   = params["FIXATION_CROSS_POSITION"], 
						  line_width = params["FIXATION_CROSS_WIDTH"],
                          colour     = params["WHITE"])
fix_cross.preload()

instructions_task = stimuli.TextScreen(heading = params["INTRO_HEADING"], heading_size = params["HEADING_SIZE"], heading_colour = params["WHITE"],
                                  text = params["INTRO_TEXT_TASK"],       text_size = params["TEXT_SIZE"],       text_colour = params["WHITE"], )
instructions_task.preload()
